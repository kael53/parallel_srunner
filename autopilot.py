...
def main(args):
    ...
    try:
        ...
        while vehicle is None:
            ...
            for possible_vehicle in possible_vehicles:
                if possible_vehicle.attributes['role_name'] == "hero":
                    print("Hero Ego vehicle found")
                    vehicle = possible_vehicle
                    break
...
if __name__ == '__main__':
    ...
    argparser.add_argument(
        ...
        default=8000,
        type=int,
        help='TrafficManager TCP port to listen to (default: 8000)')
